...
urlpatterns = [
    ...
    path('app/<slug:club_slug>/profile/appearance/',                       views.app_appearance,        name='app_appearance'),
    ...
    path('app/<slug:club_slug>/account/invoices/<int:invoice_id>/',        views.app_invoice_detail,    name='app_invoice_detail'),
